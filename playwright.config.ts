...
export default defineConfig({
  ...
  projects: [
    { name: 'acceptance', testMatch: ['room-session.spec.ts', 'generalized-room-membership-qr.spec.ts', 'participant-filters.spec.ts', 'common-filter-resolution.spec.ts'], fullyParallel: true },
    {
